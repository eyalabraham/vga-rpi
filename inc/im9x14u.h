 ...
 *
 * Input file: im9x14u.bdf
 *
 */

#ifndef __im9x14u_h__
#define __im9x14u_h__

#include    <stdint.h>

uint8_t font_img9x14[][14] = {
        // ASCII 0
        ...
        // ASCII 193
        {0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 194
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800},
        // ASCII 195
        {0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x1f, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18},
        // ASCII 196
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 197
        {0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0xff80, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800},
        // ASCII 198
        ...
        // ASCII 202
        {0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0xf780, 0x00, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 203
        {0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x00, 0xf780, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600},
        // ASCII 204
        {0x36, 0x36, 0x36, 0x36, 0x36, 0x37, 0x30, 0x37, 0x36, 0x36, 0x36, 0x36, 0x36, 0x36},
        // ASCII 205
        {0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x00, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 206
        {0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0xf780, 0x00, 0xf780, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600},
        // ASCII 207
        {0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0xff80, 0x00, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 208
        {0x36, 0x36, 0x36, 0x36, 0x36, 0x36, 0x36, 0x37, 0x36, 0x36, 0x36, 0x36, 0x36, 0x36},
        // ASCII 209
        {0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x00, 0xff80, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800},
        // ASCII 210
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600},
        // ASCII 211
        ...
        // ASCII 215
        {0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0xff80, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600, 0x3600},
        // ASCII 216
        {0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0xff80, 0x1800, 0xff80, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800, 0x1800},
        // ASCII 217
        ...
        // ASCII 219
        {0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80},
        // ASCII 220
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80},
        // ASCII 221
        {0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0},
        // ASCII 222
        {0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f},
        // ASCII 223
        {0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0xff80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        // ASCII 224
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x33, 0x36, 0x3c, 0x3c, 0x36, 0x33, 0x00, 0x00, 0x00},
        // ASCII 225
        {0x00, 0x00, 0x3c, 0x66, 0x66, 0x66, 0x6c, 0x66, 0x63, 0x63, 0x66, 0x00, 0x00, 0x00},
        // ASCII 226
        {0x00, 0x00, 0x7f, 0x33, 0x31, 0x30, 0x30, 0x30, 0x30, 0x30, 0x78, 0x00, 0x00, 0x00},
        // ASCII 227
        {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x66, 0x66, 0x66, 0x66, 0x66, 0x00, 0x00, 0x00},
        // ASCII 228
        {0x00, 0x00, 0x7f, 0x63, 0x31, 0x18, 0x0c, 0x18, 0x31, 0x63, 0x7f, 0x00, 0x00, 0x00},
        // ASCII 229
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0x6c, 0x66, 0x66, 0x66, 0x3c, 0x00, 0x00, 0x00},
        // ASCII 230
        {0x00, 0x00, 0x00, 0x00, 0x33, 0x33, 0x33, 0x33, 0x3e, 0x30, 0x30, 0x60, 0x00, 0x00},
        // ASCII 231
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x7f, 0x18, 0x18, 0x18, 0x1b, 0x0e, 0x00, 0x00, 0x00},
        // ASCII 232
        {0x00, 0x00, 0x18, 0x7e, 0xdb, 0xdb, 0xdb, 0xdb, 0x7e, 0x18, 0x3c, 0x00, 0x00, 0x00},
        // ASCII 233
        ...
        // ASCII 237
        {0x00, 0x00, 0x00, 0x00, 0x00, 0xce, 0xdb, 0xdb, 0xdb, 0x7e, 0x18, 0x18, 0x18, 0x00},
        // ASCII 238
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x3e, 0x63, 0x38, 0x60, 0x63, 0x3e, 0x00, 0x00, 0x00},
        // ASCII 239
